...
public class Watch {
	...
	public void before() throws InterruptedException {
		client = CuratorFrameworkFactory
				...
				.namespace("test").defaultData(null).build();
		client.start();
	...
	public void nodeListener() throws Exception {
		final NodeCache nodeCache = new NodeCache(client, "/node", false);
		nodeCache.start();
	...
	@Test
	public void treeListener() throws Exception {
		final TreeCache treeCache = new TreeCache(client, "/test");
